package louis.coub.netty.nio.service;
...
public class NIOClient {
    /*发送数据缓冲区*/
    private static final ByteBuffer sBuffer = ByteBuffer.allocate(1024);
    /*接受数据缓冲区*/
    private static final ByteBuffer rBuffer = ByteBuffer.allocate(1024);
    /*服务器端地址*/

### distribute transation



在讲分布式事务之前，有两个常见的理论知识需要讲解的，其一就是`CAP理论`，其二`Base理论`
...
![](../../etc/distributed/distribute_transation_CAP.jpg)
...
![img](../../etc/distributed/distribute_transation_1.jpg)
...
![img](../../etc/distributed/distribute_transation_4.jpg)

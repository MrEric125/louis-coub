...
public class AgentLogData implements org.apache.thrift.TBase<AgentLogData, AgentLogData._Fields>, java.io.Serializable, Cloneable, Comparable<AgentLogData> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("AgentLogData");
  ...
  static {
    schemes.put(StandardScheme.class, new AgentLogDataStandardSchemeFactory());
    schemes.put(TupleScheme.class, new AgentLogDataTupleSchemeFactory());
  }
  ...
  public List<AgentLogInfo> logList; // required
  ...
  static {
    ...
    tmpMap.put(_Fields.LOG_LIST, new org.apache.thrift.meta_data.FieldMetaData("logList", org.apache.thrift.TFieldRequirementType.REQUIRED, 
        new org.apache.thrift.meta_data.ListMetaData(org.apache.thrift.protocol.TType.LIST, 
            new org.apache.thrift.meta_data.FieldValueMetaData(org.apache.thrift.protocol.TType.STRUCT            , "AgentLogInfo"))));
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(AgentLogData.class, metaDataMap);
  }
   ...
   */
  public AgentLogData(AgentLogData other) {
    ...
    if (other.isSetLogList()) {
      List<AgentLogInfo> __this__logList = new ArrayList<AgentLogInfo>(other.logList.size());
      for (AgentLogInfo other_element : other.logList) {
  ...
  public AgentLogData deepCopy() {
    return new AgentLogData(this);
  }
  ...
  public AgentLogData setProCode(String proCode) {
    this.proCode = proCode;
    return this;
  }
  ...
  public AgentLogData setAppCode(String appCode) {
    this.appCode = appCode;
    return this;
  }
  ...
  public AgentLogData setInstCode(String instCode) {
  ...
  public AgentLogData setIp(String ip) {
    this.ip = ip;
    return this;
  }
  ...
  public AgentLogData setFileName(String fileName) {
    this.fileName = fileName;
    return this;
  }
  ...
  public java.util.Iterator<AgentLogInfo> getLogListIterator() {
    return (this.logList == null) ? null : this.logList.iterator();
  }

  public void addToLogList(AgentLogInfo elem) {
    if (this.logList == null) {
      this.logList = new ArrayList<AgentLogInfo>();
    }
    this.logList.add(elem);
  }

  public List<AgentLogInfo> getLogList() {
    return this.logList;
  }

  public AgentLogData setLogList(List<AgentLogInfo> logList) {
    this.logList = logList;
    return this;
  }
  ...
  public AgentLogData setTotalSize(long totalSize) {
    this.totalSize = totalSize;
    setTotalSizeIsSet(true);
    return this;
  }
  ...
  public void setFieldValue(_Fields field, Object value) {
    ...
    case LOG_LIST:
      if (value == null) {
        ...
        setLogList((List<AgentLogInfo>)value);
      }
      break;
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof AgentLogData)
      return this.equals((AgentLogData)that);
    return false;
  }

  public boolean equals(AgentLogData that) {
    if (that == null)
      return false;
  ...
  @Override
  public int compareTo(AgentLogData other) {
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("AgentLogData(");
    boolean first = true;
  ...
  private static class AgentLogDataStandardSchemeFactory implements SchemeFactory {
    public AgentLogDataStandardScheme getScheme() {
      return new AgentLogDataStandardScheme();
    }
  }

  private static class AgentLogDataStandardScheme extends StandardScheme<AgentLogData> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, AgentLogData struct) throws TException {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.logList = new ArrayList<AgentLogInfo>(_list26.size);
                AgentLogInfo _elem27;
                for (int _i28 = 0; _i28 < _list26.size; ++_i28)
                {
                  _elem27 = new AgentLogInfo();
                  _elem27.read(iprot);
                  struct.logList.add(_elem27);
                }
                iprot.readListEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, AgentLogData struct) throws TException {
      struct.validate();
      ...
      if (struct.logList != null) {
        oprot.writeFieldBegin(LOG_LIST_FIELD_DESC);
        {
          ...
          for (AgentLogInfo _iter29 : struct.logList)
          {
            _iter29.write(oprot);
          }
          oprot.writeListEnd();
  ...
  private static class AgentLogDataTupleSchemeFactory implements SchemeFactory {
    public AgentLogDataTupleScheme getScheme() {
      return new AgentLogDataTupleScheme();
    }
  }

  private static class AgentLogDataTupleScheme extends TupleScheme<AgentLogData> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, AgentLogData struct) throws TException {
      ...
      oprot.writeString(struct.fileName);
      {
        ...
        for (AgentLogInfo _iter30 : struct.logList)
        {
          _iter30.write(oprot);
        }
      }
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, AgentLogData struct) throws TException {
      ...
      struct.setFileNameIsSet(true);
      {
        ...
        struct.logList = new ArrayList<AgentLogInfo>(_list31.size);
        AgentLogInfo _elem32;
        for (int _i33 = 0; _i33 < _list31.size; ++_i33)
        {
          _elem32 = new AgentLogInfo();
          _elem32.read(iprot);
          struct.logList.add(_elem32);
        }
      }
      struct.setLogListIsSet(true);
      struct.totalSize = iprot.readI64();

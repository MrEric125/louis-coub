...
import com.oauth2.provider.provider.PcAuthorizeConfigManager;
import com.oauth2.provider.service.impl.UserService;
import com.oauth2.provider.token.TokenAuthenticationProvider;
...
//                .defaultSuccessUrl("/index.html").permitAll()        // 登录成功之后，默认跳转的页面
                ...
                .antMatchers("/user/register", "/user/login").permitAll()        // 设置所有人都可以访问登录页面
